    ...
    public class SlotHttpClientWrapperTests
    {
        ...
        public async Task GetAsync_MakesCorrectCall()
        {
            ...
            _httpTest.ShouldHaveCalled(
                "https://orange.testlab.nhs.uk/gpconnect-demonstrator/v1/fhir/" +
                ...
                .WithOAuthBearerToken(System.Convert.ToBase64String(System.Text.Encoding.ASCII.GetBytes("token")))
                .Times(1);
